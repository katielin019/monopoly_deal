...
public class GameController {
    ...
    private boolean handlePlayerMove(Player player, String input) {
        try {
    ...
    private void handlePlayerHandLimit(Player player) {
        while (player.getHand().size() > MAX_CARDS_IN_HAND) {
    ...
    private boolean isGameOver() {
        for (Player p : game.getPlayers()) {
            ...
            // TODO: call endGame() method in Game class && prevent further actions from being taken
        }
        return false;
    }
}
